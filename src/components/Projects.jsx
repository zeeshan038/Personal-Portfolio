  ...
  return (
    ...
    <div className='projects-main-container'>
      <div className='project-hero'>
        ...
        <p className='portfoio-para'>Each project is a unique <br /> piece of development💸</p>
      </div>
      <div className='pro-btn'>
        ...
        <button onClick={() => handlePro('mern')} className={activeCat === 'mern' ? 'active' : ''} id='selective-btns'>
          Mern
        </button>
      </div>
      <div className='projects-card-container flex justify-center items-center'>
        {filterPro.length === 0 ? ( 
          <div className='no-projects w-full h-60 mt-20'>
            <p>No projects yet</p>
          </div>
        ) : (
